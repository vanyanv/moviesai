...
function MovieSearch() {
  //searchValue is a selector that gets the search value from the store
  const searchValue = useSelector((state: RootState) => state.search.value);
  //useSearchMoviesQuery is a hook generated by RTK Query get movies from the API
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (movie) {
      //addToHistory is an action that adds the search value to the search history
